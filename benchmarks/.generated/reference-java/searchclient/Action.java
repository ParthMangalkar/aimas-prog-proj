...
public enum Action
{
    ...
    */
    ...
    // Push: agent moves in direction X (first letter), agent ends up in box's cell.
    // Box moves in direction Y (second letter) from its current position.
    // boxRowDelta/boxColDelta = box movement direction.
    ...
    // Pull: agent moves in direction X (first letter).
    // Box moves in direction Y (second letter) into agent's old cell.
    // boxRowDelta/boxColDelta = box movement direction (toward agent's old position).
    // The box's current position is: agent_pos - boxDelta (opposite of box movement direction).
